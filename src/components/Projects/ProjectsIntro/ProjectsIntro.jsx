    ...
    >
      <div className="grid w-full max-w-205 grid-cols-1 gap-y-5 md:grid-cols-[120px_minmax(0,1fr)] md:gap-x-5 md:gap-y-0 lg:grid-cols-[160px_minmax(0,1fr)]">
        ...
        <div className="grid min-w-0 gap-5 md:col-start-2 md:gap-7">
          ...
          <p data-reveal-part="content" className="m-0 max-w-2xl text-[13px] leading-tight font-medium text-black/65 md:text-sm">
            <span data-reveal-inner className="block">
              This archive brings together interfaces built with clean
              structure, responsive layouts, strong visual rhythm and polished
              interaction details. Each project is shaped to turn a simple idea
              into a clear digital experience that feels modern, usable and
              carefully finished.
            </span>
          </p>
